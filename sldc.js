...
const analysisOfRequirements = `This step is making sure the planning covers al the requirements of the product`
const design = `This step is writing the feature os the product`
const implementation = `This step is the actual writing of the product`
const testingAndIntegration = `This step is testing the code to make sure it works and combining all the code to make the finished product`
const maintain = `This step is taking care of the product after release`